...
public class GetFact extends AsyncTask<String, Void, String> {
    ...
    public GetFact(Context context, int number, RecyclerView recyclerView){
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            String link = "http://numbersapi.com/" + number;
